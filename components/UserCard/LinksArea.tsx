...
import styles from './styles/linksArea.module.css'
...
const LinksArea = ({ links }: LinksAreaPropos) => {
    ...
    return (
        <ul className={styles.container}>
            <li className={styles.Link}>
                ...
                <span className={styles.Data}>{links.location || "Not Available"}</span>
            </li>
            <li className={styles.Link}>
                ...
                <span className={styles.Data}>{links.company || "Not Available"}</span>
            </li>
        </ul>
    )
}
